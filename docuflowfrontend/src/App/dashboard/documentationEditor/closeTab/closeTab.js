            ...
            {(clTab.gotTab) ?
                <>
                    <div className='step-data'>
                        ...
                        <p className='step_message' contentEditable>Close the tab.</p>
                    </div>
                    <div className='pageNavPrev'>
                        ...
                        <div className='pageDets'>
                            <p className='pageTitle'>{clTab.tabDetails.data.tab.title}</p>
                            <p className='redirectedTo'>{clTab.tabDetails.data.tab.url}</p>
                        </div>
                    </div>
                </>
                :
