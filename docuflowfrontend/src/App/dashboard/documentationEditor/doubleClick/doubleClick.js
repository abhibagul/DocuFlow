    ...
    return (
        <div>
            <div className='step-data'>
                ...
                <p className='step_message' suppressContentEditableWarning={true} contentEditable> {parse(getKeysHolding(e.data.event))} Double Click on the {getClickType(e.data.event.target)}</p>
            </div>
